...
moves = [
    ...
    {"player": player_mouse, "origin": 50, "target": 57},
    {"player": player_cat, "origin": 16, "target": 25},
    {"player": player_mouse, "origin": 57, "target": 48},
    {"player": player_cat, "origin": 25, "target": 32},
    {"player": player_mouse, "origin": 48, "target": 57},
    {"player": player_cat, "origin": 32, "target": 41},
    {"player": player_mouse, "origin": 57, "target": 48},
    {"player": player_cat, "origin": 2, "target": 11},
    {"player": player_mouse, "origin": 48, "target": 57},
    {"player": player_cat, "origin": 11, "target": 18},
    {"player": player_mouse, "origin": 57, "target": 48},
    {"player": player_cat, "origin": 18, "target": 27},
    {"player": player_mouse, "origin": 48, "target": 57},
    {"player": player_cat, "origin": 27, "target": 34},
    {"player": player_mouse, "origin": 57, "target": 48},
    {"player": player_cat, "origin": 34, "target": 43},
    {"player": player_mouse, "origin": 48, "target": 57},
    {"player": player_cat, "origin": 43, "target": 50},
    {"player": player_mouse, "origin": 57, "target": 48},
    {"player": player_cat, "origin": 50, "target": 57}
]
print("---------------------")
